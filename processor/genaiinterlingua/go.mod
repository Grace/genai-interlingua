module github.com/Grace/genai-interlingua/processor/genaiinterlingua

go 1.26.0

require (
	github.com/Grace/genai-interlingua v0.0.0
...
// The core is dependency-free and stays that way. This component is a separate
// module so that `go test ./...` at the repository root, and `go run
// ./cmd/interlingua`, need none of the Collector's module graph. Every
// component in opentelemetry-collector-contrib is its own module for the same
// reason.
replace github.com/Grace/genai-interlingua => ../..
